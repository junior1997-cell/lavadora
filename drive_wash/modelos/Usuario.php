...
Class Usuario
{
	...
	public function listar_all_api_usuario()
	{
	...
	// LISTA UNA PERSONA DE LA TABLA PERSONA
	...
	public function listar_api_permiso_marcado_local($id)
	{
		 
		$curl = curl_init();

		curl_setopt_array($curl, array(
		  CURLOPT_URL => "http://localhost/git/lavadora/drive_restfull/index.php/usuariopermiso".$id,
		  CURLOPT_RETURNTRANSFER => true,
		  CURLOPT_ENCODING => "",
		  CURLOPT_MAXREDIRS => 10,
		  CURLOPT_TIMEOUT => 0,
    ...
    public function listar_una_persona_api()
    {
